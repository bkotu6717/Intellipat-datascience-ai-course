...
-- 5. What is the highest number of copies sold by a package?
    SELECT TOP 1 SW.TITLE, SUM(SW.SOLD) AS [highest number of copies sold] FROM SOFTWARE SW GROUP BY SW.TITLE ORDER BY SUM(SW.SOLD) DESC;
...
-- 10. How many programmers studied at Sabhari?
    SELECT COUNT(DISTINCT P.PNAME) AS STUDIED_AT_SABHARI FROM studies ST
